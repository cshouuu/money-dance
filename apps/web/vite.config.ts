...
function serviceWorkerPlugin(): Plugin {
  return {
    ...
    generateBundle(_options, bundle) {
      ...
      // Vite's HTML transform is finalized after some generateBundle hooks, so
      // hash the source explicitly instead of relying on index.html being in
      // the Rollup bundle at this point.
      updateHash(
        versionHash,
        'index.html',
