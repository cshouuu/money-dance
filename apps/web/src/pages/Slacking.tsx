...
export function Slacking() {
  ...
  useEffect(() => {
    saveAchievementState('slacking', achievementState)
  }, [achievementState])
  ...
  const stop = useCallback(() => {
    ...
    try {
      ...
      const durationSeconds = elapsedSecondsSince(active, new Date(endTime))
      const session: SlackingSession = {
        id: createId(),
        startTime: active,
        endTime,
        durationSeconds,
        earnedAmount: slackingEarned(active, endTime, rate),
      }
  ...
  return <section className="page">
    ...
    <AchievementPanel kind="slacking" state={achievementState} activeSeconds={liveSeconds}/>
