import { calculateRates, type SalaryHistoryMode, type SalaryProfile, type SalaryRates, type SalaryType, type WorkMode } from '@salary-flow/core'
...
import { loadProfile, recommendedMonthlyWorkDays, saveProfile } from '../lib/profile'
import './Settings.css'
