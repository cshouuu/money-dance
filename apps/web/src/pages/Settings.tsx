import { calculateRates, type AlternatingWeekType, type SalaryProfile, type SalaryRates, type SalaryType, type WorkMode, type WorkWeekMode } from '@salary-flow/core'
...
export function Settings() {
  ...
  const submit = (event: FormEvent<HTMLFormElement>) => {
    ...
    const savedProfile = { ...draftProfile, salaryEffectiveDate }
