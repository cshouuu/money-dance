...
export function WorkJourney() {
  ...
  const rates = selected?.profile ? calculateRates(salaryProfileForBusinessDate(profile, selectedEnded ? selected.endDate! : selected.startDate > today ? selected.startDate : today)) : null
