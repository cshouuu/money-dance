...
export function Assets() {
  ...
  return <section className="page"><header className="page-header"><div><p className="eyebrow">OWNERSHIP COST</p><h1>买得贵不贵，时间会给答案。</h1><p>持有时间越久，平均每小时成本越低。这里统计的是“持有成本”，不是实际使用时长。</p></div></header>
