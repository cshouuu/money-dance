...
export function Attendance() {
  ...
  return <section className="page attendance-page">
    <header className="page-header"><div><p className="eyebrow">ATTENDANCE & SALARY</p><h1>工作日历</h1><p>上班、请假还是放假，每一天都按真实出勤算钱；正常出勤也可以按倍率或固定金额调整当天工资。</p></div><div className="roster-actions"><Button variant="secondary" onClick={() => navigate('/roster')}><CalendarClock size={16}/>排班设置</Button><VacationSettingsButton/></div></header>
