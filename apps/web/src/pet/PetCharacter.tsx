...
import type { PetMood, PetPack } from '../lib/desktop'
...
export function PetCharacter({ image, pack, idlePreview = false, mood, size = 160, reducedMotion = false, reaction = null, replayKey = 0, showCue = false }: {
  pack?: PetPack | null
  idlePreview?: boolean
